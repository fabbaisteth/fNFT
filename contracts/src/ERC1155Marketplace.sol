...
contract NFTMarketplace {
    ...
    /**
        @dev This is the modifier to make - only Owner can access the function
    **/
    modifier onlyOwner() {
    ...
    function buyListToken(uint256 _sellId) external payable returns (bool) {
        ...
        */
        ...
        require(
            ...
            "buyToken: The tokens were already bought."
        );
        require(
            msg.value >= sales[_sellId].price,
            "buyToken: Needs to be greater or equal to the price."
        );
